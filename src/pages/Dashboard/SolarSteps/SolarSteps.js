...
const SolarSteps = () => {
   return (
      <Wrapper>
         <PageTitle title='Blog - Steps Before Solar Installation' />
         <Helmet>
            <meta name='title' content='Steps Before Solar Installation' />
            <meta
               property='og:title'
               content='Steps Before Solar Installation'
            />
            <meta
               name='description'
               content='Here is your guide to solar installation. We have created step-by-step guide for your solar panel installation, so you can get solar panel installed correctly'
            />
         </Helmet>
         <BlogIntroSection
