          ...
          >
            ...
            >
              <Typography variant="h5" color={"primary.dark"}>
                {
                  {
                    dashboard: dropDownTitles[0],
                    portfolio: dropDownTitles[1],
                    customerLeads: dropDownTitles[2],
                    sale: dropDownTitles[3],
                    purchase: dropDownTitles[4],
                    consultation: dropDownTitles[5],
                    profile: dropDownTitles[6],
