...
function PurchaseProductMobile({ product, showDetailModal }) {
  const images = [noImage, noImage, noImage, noImage, noImage, noImage];
    ...
    <Box sx={{ bgcolor: "#fff", pb: 10 }}>
          ...
          <Box sx={{ p: 2 }}>
            ...
            <Flex justifyContent={"space-between"}>
              <Grid>
                ...
                <Typography fontSize={"0.8rem"}>Min:2 Max:20</Typography>
              </Grid>
              <Grid>
      ...
      <Box sx={{ p: 2, bgcolor: "#F4F0E4" }}>
        ...
        <Box sx={{ py: 2 }}>
          ...
          Amet bibendum id et tellus, est nisl massa. Tortor lorem massa vitae
          tortor quis. Faucibus consequat, suspendisse ....
        </Box>
        <Box sx={{ textAlign: "end" }}>
          <Button
            onClick={showDetailModal}
