   ...
   return (
      <Box sx={{ background: '#f3f3f3', pt: 2.5 }}>
         ...
         <Helmet>
            <meta
               name='title'
               content='Solruf- India’s 1st B2B solar marketplace'
            />
            <meta
               property='og:description'
               content='Check out our Solar products. solruf products'
            />
         </Helmet>
            ...
            <Container maxWidth='xl' disableGutters={true}>
               <Box sx={{ my: 2, pb: 3 }}>
                  ...
                  {watchCategoryId === 73 && (
                     ...
                     >
                        <Typography
                           sx={{ fontSize: '2rem', color: 'rgba(0,0,0,0.3)' }}
                        >
                           No Product Found
                        </Typography>
                     </Box>
                     ...
                     >
                        {productsLoadingError && (
                           <Typography
                              ...
                              sx={{ textAlign: 'center', mt: 5, mb: 4 }}
                           >
                              Error fetching products! Try again reloading the
                              page
                           </Typography>
                        )}
                        <Grid container spacing={2} sx={{ flexGrow: 1 }}>
                           ...
                           {!productsLoading && products.length === 0 && (
                              ...
                              >
                                 ...
                                 >
                                    No Product Found in this Category and Sub
                                    Category
                                 </Typography>
                              </Box>
                           )}
