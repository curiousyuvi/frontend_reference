...
const HorizontalProductCardForMobile = ({
   productMeta,
   ...
   return (
      <Wrapper>
         ...
         <Flex sx={{ flexGrow: '1', alignItems: 'center' }}>
            ...
            <Box sx={{ width: '60%' }}>
               <ProductDetailList
                  description={`${productDetails?.main_category?.name}, ${productDetails?.sub_category?.sub_category_name}`}
                  list='Category'
               />

               <ProductDetailList
                  description={productDetails?.product_brand_name}
                  list='Brand'
               />
