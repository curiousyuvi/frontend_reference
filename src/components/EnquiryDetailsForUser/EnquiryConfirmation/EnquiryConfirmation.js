         ...
         details: [
            {
               ...
               product: {
                  ...
                  vendor: {
                     portfolio: {
                        slug: selectedBid?.portfolio?.slug,
                        id: selectedBid?.portfolio?.user_id,
                     },
                  },
               },
               ...
               main_category: enquiryDetails?.others?.product?.other?.main_category,
               sub_category: enquiryDetails?.others?.product?.other?.sub_category,
               product_brand_name: enquiryDetails?.others?.product?.other?.product_brand_name,
            },
         ],
         billing: {
